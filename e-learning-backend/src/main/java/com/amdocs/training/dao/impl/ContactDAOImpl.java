...
public class ContactDAOImpl implements ContactDAO {
    ...
    public boolean create() {
        String query="create table contact(user_id int references user1 , name varchar(30), Email varchar(20), Phone_no int8, Message varchar(20), contact_id int auto_increment primary key)";
        try{
