...
public class UserDAOImpl implements UserDAO {
    ...
    public boolean create() {
        String query="create table user1(user_id int primary key auto_increment, name varchar(100),phone_no int8, email varchar(100), address varchar(100), reg_date varchar(50), password varchar(100), upload_photo long)";
        try{
