...
<ul>
  ...
  <li><a class="active" href="admin.jsp">Admin</a>
...
<form action="adminadd" method="POST">
    <pre>
    <p class="txtfld">Admin ID</p> <input class="inputfld1" type="number" name="adminid">
    ...
    <p class="txtfld">Assign Password</p><input class="inputfld" type="text" name="password">
    
                <input class="submitbutton" type="submit" value="Add Admin"><br>
    </pre>
</form>  
<center><p class="heading">Update Admin</p></center> 
...
<form action="adminupdate" method="POST">
    ...
    <p class="txtfld">Name</p><input class="inputfld" type="text" name="name">
    <p class="txtfld">Email</p><input class="inputfld" type="email" name="email">
    <p class="txtfld">New Password</p><input class="inputfld" type="password" name="password">
    
                <input class="submitbutton" type="submit" value="Update Admin"><br>
    </pre>
</form>  
<center><p class="heading">Delete Admin</p></center> 
...
<form action="admindel" method="POST">
    <pre>
     ...
     <p class="txtfld">Admin ID</p><input class="inputfld" type="number" name="adminid">
     	<input class="deletebutton" type="submit" value="Delete Admin"><br>
                
     
    </pre>
</form>
 <center><p class="heading">Admin Table</p></center> 
<%
try {
...
<button class="submitbutton1" type="refresh">Refresh</button></TD>
</TR>
</TABLE>
</font>
