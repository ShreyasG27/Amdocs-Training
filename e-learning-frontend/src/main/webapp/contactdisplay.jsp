...
<center><p class="heading">Add Contact</p></center>
...
<form action="contact" method="POST">
    ...
    <p class="txtfld">Message</p><input class="inputfld" type="text" name="message">
                ...
                <input class="deletebutton" type="submit" value="Submit"><br>
    </pre>
</form>  
<center><p class="heading">Update Contact</p></center> 
...
<form action="contactupdate" method="POST">
    <pre>
     ...
     <p class="txtfld">Name</p><input class="inputfld" type="text" name="name">
     <p class="txtfld">Email</p><input class="inputfld" type="text" name="email">
     <p class="txtfld">Phone no.</p><input class="inputfld" type="number" name="phone">
     <p class="txtfld">Message</p><input class="inputfld" type="text" name="message">
     	<input class="deletebutton" type="submit" value="Update Contact"><br>
...
<form action="contactdel" method="POST">
 ...
 <center><p class="heading">Contact Table</p></center> 
<%
try {
